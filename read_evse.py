            ...
            if serialClient.is_socket_open():
                if 1==cycle:
                    ...
                    if TOTAL_CONFIG_REGISTERS == len(rq.registers):
                        ...
                        print("  b6 | AN pullup is disabled                             : {}".format(rq.registers[5]&64>0))
                        print("  b7 | PWM debug enabled                                 : {}".format(rq.registers[5]&128>0))
                        print("  b8 | error LED routing to AN out                       : {}".format(rq.registers[5]&256>0))
                        print("  b9 | pilot auto recover delay                          : {}".format(rq.registers[5]&512>0))
                        print("  .. | reserved")
                        print(" b12 | enable startup delay                              : {}".format(rq.registers[5]&4096>0))
